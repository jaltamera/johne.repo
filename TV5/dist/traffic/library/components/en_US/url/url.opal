...
<DejimaAgentNetwork CoreVersion="4.0.2.136 " SDKVersion="4.0.2.136 " locale="en_US">
  ...
  <DejimaAgentNetworkAgentList TopAgent="Url.com.dejima.library.regularexpression.RegularExpressionAgent@url">
    <Agent>
      <Properties Type="com.dejima.core.agents.ActuationAgent">
        <Address Type="com.dejima.core.kernel.AgentAddress">
          <Properties Type="com.dejima.core.kernel.AgentAddress">
            ...
            <DomainName Type="java.lang.String"><![CDATA[url]]></DomainName>
      ...
      <SendsTo messageType="com.dejima.core.messages.DelegationMessage">
        <Address Type="com.dejima.core.kernel.AgentAddress">
          <Properties Type="com.dejima.core.kernel.AgentAddress">
            ...
            <DomainName Type="java.lang.String"><![CDATA[url]]></DomainName>
            <Name Type="java.lang.String"><![CDATA[Url]]></Name>
          </Properties>
        </Address>
      </SendsTo>
      ...
      <Properties Type="com.dejima.library.regularexpression.RegularExpressionAgent">
        ...
        <ExplanationFile Type="com.dejima.core.agents.FileProperty">
          <Properties Type="com.dejima.core.agents.FileProperty">
            <Directory Type="java.lang.String"><![CDATA[url]]></Directory>
            <IsLibraryCopy Type="boolean"><![CDATA[true]]></IsLibraryCopy>
            <Name Type="java.lang.String"><![CDATA[explanation.xml]]></Name>
            <Source Type="java.lang.String"><![CDATA[url\explanation.xml]]></Source>
          </Properties>
        </ExplanationFile>
        <RegularExpression Type="java.lang.String"><![CDATA[([a-zA-Z0-9\,\;\?\'\+&amp;%\$#\=~_\-]+:?[./\\][a-zA-Z0-9\,\;\?\'\+&amp;%\$#\=~_\-]+:?[./\\][a-zA-Z0-9.:/\\\,\;\?\'\+&amp;%\$#\=~_\-]*)|((file|ldap|http|https|ftp)://([^\s$])*)]]></RegularExpression>
        <Tag Type="java.lang.String"><![CDATA[Url]]></Tag>
        <Uri Type="java.lang.String"><![CDATA[url]]></Uri>
      </Properties>
      <SendsTo messageType="com.dejima.core.messages.ActuationMessage">
        <Address Type="com.dejima.core.kernel.AgentAddress">
          <Properties Type="com.dejima.core.kernel.AgentAddress">
  ...
  <DejimaAgentNetworkLocations AgentEditorType="SWING">
    <AgentVisualization name="actuator" className="com.dejima.core.agents.ActuationAgent" domainName="url" xLocation="468" yLocation="126" expanded="true" visible="true" />
    <AgentVisualization name="io" className="com.dejima.core.agents.InteractionAgent" domainName="url" xLocation="271" yLocation="113" expanded="true" visible="true" />
    <AgentVisualization name="Log" className="com.dejima.core.agents.LogAgent" domainName="url" xLocation="113" yLocation="151" expanded="true" visible="true" />
    <AgentVisualization name="Url" className="com.dejima.library.regularexpression.RegularExpressionAgent" domainName="url" xLocation="370" yLocation="203" expanded="true" visible="true" />
