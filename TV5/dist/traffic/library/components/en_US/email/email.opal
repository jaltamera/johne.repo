...
<DejimaAgentNetwork CoreVersion="4.5.0.67 " SDKVersion="4.5.0.67 " locale="en_US">
  ...
  <DejimaAgentNetworkAgentList TopAgent="EmailAddress.com.dejima.library.regularexpression.RegularExpressionAgent@email">
    <Agent>
      <Properties Type="com.dejima.core.agents.ActuationAgent">
        <Address Type="com.dejima.core.kernel.AgentAddress">
          <Properties Type="com.dejima.core.kernel.AgentAddress">
            ...
            <DomainName Type="java.lang.String"><![CDATA[email]]></DomainName>
      ...
      <SendsTo messageType="com.dejima.core.messages.DelegationMessage">
        <Address Type="com.dejima.core.kernel.AgentAddress">
          <Properties Type="com.dejima.core.kernel.AgentAddress">
            ...
            <DomainName Type="java.lang.String"><![CDATA[email]]></DomainName>
            <Name Type="java.lang.String"><![CDATA[EmailAddress]]></Name>
          </Properties>
        </Address>
      </SendsTo>
    ...
    <Agent>
      <Properties Type="com.dejima.library.regularexpression.RegularExpressionAgent">
        ...
        <Description Type="com.dejima.core.kernel.AgentDescription">
          <Properties Type="com.dejima.core.kernel.AgentDescription">
            <Functionality Type="java.lang.String"><![CDATA[Uses regular expressions to claim email addresses.]]></Functionality>
            <Icon Type="java.lang.String"><![CDATA[/resources/agent.gif]]></Icon>
          </Properties>
        </Description>
        <ExplanationFile Type="com.dejima.core.agents.FileProperty">
          <Properties Type="com.dejima.core.agents.FileProperty">
            <Directory Type="java.lang.String"><![CDATA[email]]></Directory>
            <IsLibraryCopy Type="boolean"><![CDATA[true]]></IsLibraryCopy>
            <Name Type="java.lang.String"><![CDATA[explanation.xml]]></Name>
            <Source Type="java.lang.String"><![CDATA[email\explanation.xml]]></Source>
          </Properties>
        </ExplanationFile>
        <RegularExpression Type="java.lang.String"><![CDATA[([a-zA-Z])([\p{Alnum}]|_|-|\.)*@([\p{Alnum}|_|-])+(\.[\p{Alnum}|_|-]+)+]]></RegularExpression>
        <Tag Type="java.lang.String"><![CDATA[EmailAddress]]></Tag>
        <Uri Type="java.lang.String"><![CDATA[email]]></Uri>
      </Properties>
  ...
  <DejimaAgentNetworkLocations AgentEditorType="SWING">
    <AgentVisualization name="actuator" className="com.dejima.core.agents.ActuationAgent" domainName="email" xLocation="433" yLocation="126" expanded="true" visible="true" />
    <AgentVisualization name="EmailAddress" className="com.dejima.library.regularexpression.RegularExpressionAgent" domainName="email" xLocation="350" yLocation="209" expanded="true" visible="true" />
    <AgentVisualization name="io" className="com.dejima.core.agents.InteractionAgent" domainName="email" xLocation="236" yLocation="113" expanded="true" visible="true" />
    <AgentVisualization name="Log" className="com.dejima.core.agents.LogAgent" domainName="email" xLocation="113" yLocation="142" expanded="true" visible="true" />
