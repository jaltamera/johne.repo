...
<DejimaAgentNetwork CoreVersion="5.0.0.200 " SDKVersion="5.0.0.200 " locale="en_US">
      ...
      <Properties Type="com.dejima.templates.TemplatizedAgent">
        ...
        <TemplateInfo Type="com.dejima.core.agents.FileProperty">
          <Properties Type="com.dejima.core.agents.FileProperty">
            <Directory Type="java.lang.String" />
            <IsLibraryCopy Type="boolean"><![CDATA[false]]></IsLibraryCopy>
            <Name Type="java.lang.String"><![CDATA[nameGuesser.template]]></Name>
            <Source Type="java.lang.String"><![CDATA[nameGuesser.template]]></Source>
          </Properties>
        </TemplateInfo>
      </Properties>
  ...
  <DejimaAgentNetworkLocations AgentEditorType="SWING">
    ...
    <AgentVisualization name="Name" className="com.dejima.templates.TemplatizedAgent" domainName="name" xLocation="372" yLocation="346" expanded="true" visible="true" />
