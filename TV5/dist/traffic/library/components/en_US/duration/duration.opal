...
<DejimaAgentNetwork CoreVersion="4.0.2.157 " SDKVersion="4.0.2.157 " locale="en_US">
  ...
  <DejimaAgentNetworkAgentList TopAgent="Duration.com.dejima.templates.TemplatizedAgent@duration">
    <Agent>
      <Properties Type="com.dejima.core.agents.ActuationAgent">
        <Address Type="com.dejima.core.kernel.AgentAddress">
          <Properties Type="com.dejima.core.kernel.AgentAddress">
            ...
            <DomainName Type="java.lang.String"><![CDATA[duration]]></DomainName>
      ...
      <SendsTo messageType="com.dejima.core.messages.DelegationMessage">
        <Address Type="com.dejima.core.kernel.AgentAddress">
          <Properties Type="com.dejima.core.kernel.AgentAddress">
            ...
            <DomainName Type="java.lang.String"><![CDATA[duration]]></DomainName>
            <Name Type="java.lang.String"><![CDATA[Duration]]></Name>
          </Properties>
        </Address>
      </SendsTo>
      ...
      <Properties Type="com.dejima.core.agents.AASAPAgent">
        <Address Type="com.dejima.core.kernel.AgentAddress">
          <Properties Type="com.dejima.core.kernel.AgentAddress">
            ...
            <DomainName Type="java.lang.String"><![CDATA[duration]]></DomainName>
            <Name Type="java.lang.String"><![CDATA[DatePeriod]]></Name>
          </Properties>
        </Address>
        ...
        <Policies Type="java.lang.String"><![CDATA[dayKwd:
   'day'
...
days:
	TENS_NUMBERS dayKwd
   {attributes: 'private, atomic'}
	{action: setTag('day'), TENS_NUMBERS}
;
...
aWeek:
	'a' weekKwd
   {attributes: 'private, atomic'}
	{action: setTag('week'), '1'}
;

weeks:
	TENS_NUMBERS weekKwd
   {attributes: 'private, atomic'}
	{action: setTag('week'), TENS_NUMBERS}
;
...
aMonth:
	'a' monthKwd
   {attributes: 'private, atomic'}
	{action: setTag('month'), '1'}
;

monthes:
	TENS_NUMBERS monthKwd
   {attributes: 'private, atomic'}
	{action: setTag('month'), TENS_NUMBERS}
;
...
aQuarter:
	'a' quarterKwd
   {attributes: 'private, atomic'}
	{action: setTag('quarter'), addElement('offset', '1')}
;

quarters:
	TENS_NUMBERS quarterKwd
   {attributes: 'private, atomic'}
	{action: setTag('quarter'), TENS_NUMBERS}
;
...
aYear:
	'a' yearKwd
   {attributes: 'private, atomic'}
	{action: setTag('year'), '1'}
;

years:
	TENS_NUMBERS yearKwd
   {attributes: 'private, atomic'}
	{action: setTag('year'), TENS_NUMBERS}
;
...
compoundPeriod:
    year ['and'] ~| quarter ['and'] ~| month ['and'] ~| ['and'] week ~| day ['and'] 
   {attributes: 'private, atomic'}
;
...
;]]></Policies>
        <SynonymTable Type="com.dejima.core.nlp.text.SynonymTable">
          <Properties Type="com.dejima.core.nlp.text.FileBasedSynonymTable">
            ...
            <Name Type="java.lang.String"><![CDATA[duration.synonym]]></Name>
            <Source Type="java.lang.String"><![CDATA[duration.synonym]]></Source>
          </Properties>
        </SynonymTable>
      </Properties>
      ...
      <Properties Type="com.dejima.templates.TemplatizedAgent">
        ...
        <ExplanationFile Type="com.dejima.core.agents.FileProperty">
          <Properties Type="com.dejima.core.agents.FileProperty">
            <Directory Type="java.lang.String"><![CDATA[duration]]></Directory>
            <IsLibraryCopy Type="boolean"><![CDATA[true]]></IsLibraryCopy>
            <Name Type="java.lang.String"><![CDATA[explanation.xml]]></Name>
            <Source Type="java.lang.String"><![CDATA[duration\explanation.xml]]></Source>
          </Properties>
        </ExplanationFile>
        ...
        <Tag Type="java.lang.String"><![CDATA[Duration]]></Tag>
        <TemplateInfo Type="com.dejima.core.agents.FileProperty">
          <Properties Type="com.dejima.core.agents.FileProperty">
            <Directory Type="java.lang.String" />
            <IsLibraryCopy Type="boolean"><![CDATA[false]]></IsLibraryCopy>
            <Name Type="java.lang.String"><![CDATA[duration.template]]></Name>
            <Source Type="java.lang.String"><![CDATA[duration.template]]></Source>
          </Properties>
        </TemplateInfo>
        ...
        <Uri Type="java.lang.String"><![CDATA[duration]]></Uri>
      </Properties>
      <SendsTo messageType="com.dejima.core.messages.ActuationMessage">
        <Address Type="com.dejima.core.kernel.AgentAddress">
          <Properties Type="com.dejima.core.kernel.AgentAddress">
      ...
      <Properties Type="com.dejima.core.agents.AASAPAgent">
        <Address Type="com.dejima.core.kernel.AgentAddress">
          <Properties Type="com.dejima.core.kernel.AgentAddress">
            <ClassName Type="java.lang.String"><![CDATA[com.dejima.core.agents.AASAPAgent]]></ClassName>
            <DomainName Type="java.lang.String"><![CDATA[duration]]></DomainName>
            <Name Type="java.lang.String"><![CDATA[HOUR]]></Name>
          </Properties>
        </Address>
        <Criteria Type="com.dejima.core.nlp.text.MatchCriteria">
          <Properties Type="com.dejima.core.nlp.text.MatchCriteria">
      ...
      <Properties Type="com.dejima.core.agents.AASAPAgent">
        <Address Type="com.dejima.core.kernel.AgentAddress">
          <Properties Type="com.dejima.core.kernel.AgentAddress">
            <ClassName Type="java.lang.String"><![CDATA[com.dejima.core.agents.AASAPAgent]]></ClassName>
            <DomainName Type="java.lang.String"><![CDATA[duration]]></DomainName>
            <Name Type="java.lang.String"><![CDATA[MINUTE]]></Name>
          </Properties>
        </Address>
        <Criteria Type="com.dejima.core.nlp.text.MatchCriteria">
          <Properties Type="com.dejima.core.nlp.text.MatchCriteria">
...
;]]></Policies>
    ...
    <Agent>
      <Properties Type="com.dejima.core.agents.AASAPAgent">
        ...
        <Policies Type="java.lang.String"><![CDATA[compoundPeriod:
    TimePeriod ['and'] DatePeriod | DatePeriod ['and'] TimePeriod
    {attributes: 'private, atomic'}
;

periods:
	(TimePeriod | DatePeriod | compoundPeriod)+
    {attributes: 'atomic'}
;]]></Policies>
        <SynonymTable Type="com.dejima.core.nlp.text.SynonymTable">
          <Properties Type="com.dejima.core.nlp.text.FileBasedSynonymTable">
...
;]]></Policies>
    ...
    <Agent>
      <Properties Type="com.dejima.core.agents.AASAPAgent">
        ...
        <Policies Type="java.lang.String"><![CDATA[implicitHour:
   HOUR
   {attributes: 'private'}
   {action: setTag('hour'), HOUR}
;
...
implicitHalfAnHour:
   'half' | '1/2' | '0.5' 
   {attributes: 'private'}
   {action: setTag('minute'), 30}
;

explicitHalfAnHour:
   implicitHalfAnHour ['an'] hourKwd
   {attributes: 'private'}
   {action: implicitHalfAnHour}
;
...
explicitHour:
	implicitHour hourKwd | explicitOneHour | explicitHalfAnHour
	{attributes: 'private'}
	{action: implicitHour, explicitOneHour, explicitHalfAnHour}
;

minuteKwd:
	'minute'
	{attributes: 'private'}
	{action: setTag('minute')}
;

implicitMinute:
   MINUTE
   {attributes: 'private'}
   {action: setTag('minute'), MINUTE}
;

explicitMinute:
	implicitMinute minuteKwd
	{attributes: 'private'}
	{action: implicitMinute}
;

explicitHourMinute:
	(explicitHour ['and'] explicitMinute)
	{attributes: 'private'}
;

explicitHourAndHalf:
	explicitHour 'and' ['a'] implicitHalfAnHour | implicitHour 'and' ['a'] explicitHalfAnHour
	{attributes: 'private'}
	{action: explicitHour, implicitHalfAnHour, implicitHour, explicitHalfAnHour}
;

timePeriods:
	(explicitHour | explicitMinute | explicitHourMinute | explicitHourAndHalf)+
;]]></Policies>
        <SynonymTable Type="com.dejima.core.nlp.text.SynonymTable">
          <Properties Type="com.dejima.core.nlp.text.FileBasedSynonymTable">
            <Directory Type="java.lang.String" />
  ...
  <DejimaAgentNetworkLocations AgentEditorType="SWING">
    <AgentVisualization name="actuator" className="com.dejima.core.agents.ActuationAgent" domainName="duration" xLocation="431" yLocation="126" expanded="true" visible="true" />
    <AgentVisualization name="DatePeriod" className="com.dejima.core.agents.AASAPAgent" domainName="duration" xLocation="387" yLocation="350" expanded="true" visible="true" />
    <AgentVisualization name="Duration" className="com.dejima.templates.TemplatizedAgent" domainName="duration" xLocation="334" yLocation="220" expanded="true" visible="true" />
    <AgentVisualization name="HOUR" className="com.dejima.core.agents.AASAPAgent" domainName="duration" xLocation="300" yLocation="426" expanded="true" visible="true" />
    <AgentVisualization name="io" className="com.dejima.core.agents.InteractionAgent" domainName="duration" xLocation="234" yLocation="113" expanded="true" visible="true" />
    <AgentVisualization name="Log" className="com.dejima.core.agents.LogAgent" domainName="duration" xLocation="113" yLocation="148" expanded="true" visible="true" />
    <AgentVisualization name="MINUTE" className="com.dejima.core.agents.AASAPAgent" domainName="duration" xLocation="212" yLocation="492" expanded="true" visible="true" />
    <AgentVisualization name="ONES_IN_LETTERS" className="com.dejima.core.agents.AASAPAgent" domainName="duration" xLocation="340" yLocation="695" expanded="true" visible="true" />
    <AgentVisualization name="Period" className="com.dejima.core.agents.AASAPAgent" domainName="duration" xLocation="334" yLocation="292" expanded="true" visible="true" />
    <AgentVisualization name="TEENS_IN_LETTERS" className="com.dejima.core.agents.AASAPAgent" domainName="duration" xLocation="173" yLocation="675" expanded="true" visible="true" />
    <AgentVisualization name="TENS_IN_LETTERS" className="com.dejima.core.agents.AASAPAgent" domainName="duration" xLocation="409" yLocation="646" expanded="true" visible="true" />
    <AgentVisualization name="TENS_NUMBERS" className="com.dejima.core.agents.AASAPAgent" domainName="duration" xLocation="389" yLocation="453" expanded="true" visible="true" />
    <AgentVisualization name="TENS_NUMBERS_IN_LETTERS" className="com.dejima.core.agents.AASAPAgent" domainName="duration" xLocation="250" yLocation="572" expanded="true" visible="true" />
    <AgentVisualization name="TEXTMINUTE" className="com.dejima.core.agents.AASAPAgent" domainName="duration" xLocation="261" yLocation="459" expanded="true" visible="true" />
    <AgentVisualization name="TimePeriod" className="com.dejima.core.agents.AASAPAgent" domainName="duration" xLocation="254" yLocation="354" expanded="true" visible="true" />
