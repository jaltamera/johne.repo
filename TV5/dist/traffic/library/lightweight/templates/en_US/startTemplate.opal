...
<DejimaAgentNetwork CoreVersion="4.5.0.43 " SDKVersion="4.5.0.43 " locale="en_US">
  ...
  <DejimaAgentNetworkLocations AgentEditorType="SWING">
    ...
    <AgentVisualization name="Interpretation" className="com.dejima.core.agents.SynonymLearningAgent" domainName="x" xLocation="252" yLocation="249" expanded="true" visible="true" />
    ...
    <AgentVisualization name="System" className="com.dejima.templates.TemplatizedAgent" domainName="x" xLocation="252" yLocation="322" expanded="true" visible="true" />
