...
<DejimaAgentNetwork CoreVersion="4.5.1.1 " SDKVersion="4.5.1.1 " locale="en_US">
...
;]]></Policies>
	...
	'since' ['last'] (PERIOD| AbsoluteDate |WEEKDAY) ['ago'] | ('in' 'past' PERIOD) | (['in'] 'past' OFFSETED_PERIOD)
	{action: setTag('past'), PERIOD, AbsoluteDate, WEEKDAY, OFFSETED_PERIOD}
;

FUTURE_PERIODS:
	(('by'|'until') ['end of'] ['next'] (PERIOD|OFFSETED_PERIOD|AbsoluteDate|WEEKDAY)) | (('in' | (['in'] 'next')) OFFSETED_PERIOD)
	{action: setTag('future'), PERIOD, OFFSETED_PERIOD, AbsoluteDate, WEEKDAY}
;
...
PAST_PERIODS:
	[WEEKDAY] PAST_PERIOD_ | PAST_PERIOD_ WEEKDAY | ['in'] 'last' PERIOD
	{action: setTag('past'), PAST_PERIOD_, WEEKDAY, PERIOD}
;
...
FUTURE_PERIODS:
	['in'] 'next' PERIOD | OFFSETED_PERIOD 'later' | ORDINAL_PERIOD | FORTNIGHT
	{action: setTag('future'), PERIOD, OFFSETED_PERIOD, ORDINAL_PERIOD, FORTNIGHT}
;
...
;]]></Policies>
  ...
  <DejimaAgentNetworkLocations AgentEditorType="SWING">
    <AgentVisualization name="AbsoluteDate" className="com.dejima.core.agents.AASAPAgent" domainName="date" xLocation="781" yLocation="629" expanded="true" visible="true" />
    ...
    <AgentVisualization name="RANGE_TENSE" className="com.dejima.core.agents.AASAPAgent" domainName="date" xLocation="559" yLocation="588" expanded="true" visible="true" />
