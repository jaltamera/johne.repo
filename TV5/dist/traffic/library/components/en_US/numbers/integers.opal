...
<DejimaAgentNetwork CoreVersion="4.5.1.8 " SDKVersion="4.5.1.8 " locale="en_US">
  ...
  <DejimaAgentNetworkAgentList TopAgent="Integer.com.dejima.templates.TemplatizedAgent@integers">
    <Agent>
...
;]]></Policies>
    ...
    <Agent>
      <Properties Type="com.dejima.templates.TemplatizedAgent">
        ...
        <Tag Type="java.lang.String"><![CDATA[Integer]]></Tag>
        ...
        <Uri Type="java.lang.String"><![CDATA[integers]]></Uri>
      </Properties>
      <SendsTo messageType="com.dejima.core.messages.ActuationMessage">
        <Address Type="com.dejima.core.kernel.AgentAddress">
          <Properties Type="com.dejima.core.kernel.AgentAddress">
...
;]]></Policies>
  ...
  <DejimaAgentNetworkLocations AgentEditorType="SWING">
    <AgentVisualization name="Actuator" className="com.dejima.serviceProviders.ServiceProvidersActuationAgent" domainName="integers" xLocation="413" yLocation="117" expanded="true" visible="true" />
    <AgentVisualization name="HUNDREDS" className="com.dejima.core.agents.AASAPAgent" domainName="integers" xLocation="317" yLocation="523" expanded="true" visible="true" />
    <AgentVisualization name="HUNDREDS_NUMERALS" className="com.dejima.core.agents.AASAPAgent" domainName="integers" xLocation="317" yLocation="459" expanded="true" visible="true" />
    <AgentVisualization name="Integer" className="com.dejima.templates.TemplatizedAgent" domainName="integers" xLocation="317" yLocation="387" expanded="true" visible="true" />
    <AgentVisualization name="Interaction" className="com.dejima.core.agents.PresentationAgent" domainName="integers" xLocation="195" yLocation="113" expanded="true" visible="true" />
    <AgentVisualization name="LiveInterpretation" className="com.dejima.liveInterpretation.LiveInterpretationAgent" domainName="integers" xLocation="246" yLocation="167" expanded="true" visible="true" />
    <AgentVisualization name="Log" className="com.dejima.core.agents.LogAgent" domainName="integers" xLocation="113" yLocation="271" expanded="true" visible="true" />
    <AgentVisualization name="ONES" className="com.dejima.core.agents.AASAPAgent" domainName="integers" xLocation="394" yLocation="654" expanded="true" visible="true" />
    <AgentVisualization name="System" className="com.dejima.templates.TemplatizedAgent" domainName="integers" xLocation="317" yLocation="323" expanded="true" visible="true" />
    <AgentVisualization name="TEENS" className="com.dejima.core.agents.AASAPAgent" domainName="integers" xLocation="246" yLocation="654" expanded="true" visible="true" />
    <AgentVisualization name="TENS" className="com.dejima.core.agents.AASAPAgent" domainName="integers" xLocation="317" yLocation="601" expanded="true" visible="true" />
    <AgentVisualization name="Top" className="com.dejima.core.agents.SynonymLearningAgent" domainName="integers" xLocation="317" yLocation="255" expanded="true" visible="true" />
