...
<DejimaAgentNetwork CoreVersion="4.0.2.128 " SDKVersion="4.0.2.128 " locale="en_US">
  ...
  <DejimaAgentNetworkAgentList TopAgent="Phone.com.dejima.library.regularexpression.RegularExpressionAgent@us_phone">
    <Agent>
      <Properties Type="com.dejima.core.agents.ActuationAgent">
        <Address Type="com.dejima.core.kernel.AgentAddress">
          <Properties Type="com.dejima.core.kernel.AgentAddress">
            ...
            <DomainName Type="java.lang.String"><![CDATA[us_phone]]></DomainName>
      ...
      <Properties Type="com.dejima.library.regularexpression.RegularExpressionAgent">
        ...
        <Address Type="com.dejima.core.kernel.AgentAddress">
          <Properties Type="com.dejima.core.kernel.AgentAddress">
            ...
            <DomainName Type="java.lang.String"><![CDATA[us_phone]]></DomainName>
            <Name Type="java.lang.String"><![CDATA[Phone]]></Name>
          </Properties>
        </Address>
        ...
        <ExplanationFile Type="com.dejima.core.agents.FileProperty">
          <Properties Type="com.dejima.core.agents.FileProperty">
            <Directory Type="java.lang.String"><![CDATA[phone]]></Directory>
            <IsLibraryCopy Type="boolean"><![CDATA[true]]></IsLibraryCopy>
            <Name Type="java.lang.String"><![CDATA[explanation.xml]]></Name>
            <Source Type="java.lang.String"><![CDATA[phone\explanation.xml]]></Source>
          </Properties>
        </ExplanationFile>
        <RegularExpression Type="java.lang.String"><![CDATA[(1?\s*-?\s*(\d{3}|\(\s*\d{3}\s*\))\s*-?\s*)?\d{3}\s*-?\s*\d{4}]]></RegularExpression>
        <Tag Type="java.lang.String"><![CDATA[Phone]]></Tag>
        <Uri Type="java.lang.String"><![CDATA[us_phone]]></Uri>
      </Properties>
      <SendsTo messageType="com.dejima.core.messages.ActuationMessage">
        <Address Type="com.dejima.core.kernel.AgentAddress">
          <Properties Type="com.dejima.core.kernel.AgentAddress">
    ...
    <Agent>
      <Properties Type="com.dejima.core.agents.AASAPAgent">
        ...
        <Policies Type="java.lang.String"><![CDATA[usPhone:
	Phone+
;]]></Policies>
      </Properties>
      <SendsTo messageType="com.dejima.core.messages.ActuationMessage">
  ...
  <DejimaAgentNetworkLocations AgentEditorType="SWING">
    <AgentVisualization name="actuator" className="com.dejima.core.agents.ActuationAgent" domainName="us_phone" xLocation="422" yLocation="162" expanded="true" visible="true" />
    <AgentVisualization name="io" className="com.dejima.core.agents.InteractionAgent" domainName="us_phone" xLocation="225" yLocation="149" expanded="true" visible="true" />
    <AgentVisualization name="Log" className="com.dejima.core.agents.LogAgent" domainName="us_phone" xLocation="113" yLocation="163" expanded="true" visible="true" />
    <AgentVisualization name="Phone" className="com.dejima.library.regularexpression.RegularExpressionAgent" domainName="us_phone" xLocation="322" yLocation="320" expanded="true" visible="true" />
    <AgentVisualization name="System" className="com.dejima.core.agents.AASAPAgent" domainName="us_phone" xLocation="322" yLocation="252" expanded="true" visible="true" />
