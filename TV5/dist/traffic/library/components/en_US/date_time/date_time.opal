...
<DejimaAgentNetwork CoreVersion="5.0.0.260 " SDKVersion="5.0.0.260 " locale="en_US">
      ...
      <Properties Type="com.dejima.core.agents.ComponentNetworkAgent">
        ...
        <ComponentNetworkInfo Type="com.dejima.core.agents.FileProperty">
          <Properties Type="com.dejima.core.agents.FileProperty">
            ...
            <Name Type="java.lang.String"><![CDATA[date.opal]]></Name>
            <Source Type="java.lang.String"><![CDATA[date\date.opal]]></Source>
          </Properties>
        ...
        <UseFullAgentNames Type="boolean"><![CDATA[true]]></UseFullAgentNames>
      </Properties>
      ...
      <Properties Type="com.dejima.core.agents.ComponentNetworkAgent">
        ...
        <ComponentNetworkInfo Type="com.dejima.core.agents.FileProperty">
          <Properties Type="com.dejima.core.agents.FileProperty">
            ...
            <IsLibraryCopy Type="boolean"><![CDATA[false]]></IsLibraryCopy>
            <Name Type="java.lang.String"><![CDATA[time.opal]]></Name>
            <Source Type="java.lang.String"><![CDATA[time\time.opal]]></Source>
          </Properties>
        </ComponentNetworkInfo>
        <Criteria Type="com.dejima.core.nlp.text.MatchCriteria">
          <Properties Type="com.dejima.core.nlp.text.MatchCriteria">
  ...
  <DejimaAgentNetworkLocations AgentEditorType="SWING">
    <AgentVisualization name="Actuator" className="com.dejima.serviceProviders.ServiceProvidersActuationAgent" domainName="date_time" xLocation="472" yLocation="117" expanded="true" visible="true" />
    <AgentVisualization name="Date" className="com.dejima.core.agents.ComponentNetworkAgent" domainName="date_time" xLocation="432" yLocation="444" expanded="true" visible="true" />
    <AgentVisualization name="DateTime" className="com.dejima.templates.TemplatizedAgent" domainName="date_time" xLocation="362" yLocation="350" expanded="true" visible="true" />
    <AgentVisualization name="DejimaInterpretation" className="com.dejima.core.agents.SynonymLearningAgent" domainName="date_time" xLocation="362" yLocation="238" expanded="true" visible="true" />
    <AgentVisualization name="Interaction" className="com.dejima.core.agents.PresentationAgent" domainName="date_time" xLocation="254" yLocation="113" expanded="true" visible="true" />
    <AgentVisualization name="LiveInterpretation" className="com.dejima.liveInterpretation.LiveInterpretationAgent" domainName="date_time" xLocation="303" yLocation="169" expanded="true" visible="true" />
    <AgentVisualization name="Log" className="com.dejima.core.agents.LogAgent" domainName="date_time" xLocation="113" yLocation="188" expanded="true" visible="true" />
    <AgentVisualization name="System" className="com.dejima.templates.TemplatizedAgent" domainName="date_time" xLocation="362" yLocation="296" expanded="true" visible="true" />
    <AgentVisualization name="Time" className="com.dejima.core.agents.ComponentNetworkAgent" domainName="date_time" xLocation="299" yLocation="445" expanded="true" visible="true" />
