...
<DejimaAgentNetwork CoreVersion="4.0.2.128 " SDKVersion="4.0.2.128 " locale="en_US">
  ...
  <DejimaAgentNetworkAgentList TopAgent="SYSTEM.com.dejima.core.agents.AASAPAgent@x">
    <Agent>
      ...
      <Properties Type="com.dejima.core.agents.AASAPAgent">
        <Address Type="com.dejima.core.kernel.AgentAddress">
          <Properties Type="com.dejima.core.kernel.AgentAddress">
            <ClassName Type="java.lang.String"><![CDATA[com.dejima.core.agents.AASAPAgent]]></ClassName>
            <DomainName Type="java.lang.String"><![CDATA[x]]></DomainName>
            <Name Type="java.lang.String"><![CDATA[CHEAP]]></Name>
          </Properties>
        </Address>
	...
	'cheap'
	{action: '&lt;less&gt;', get(CONST_PRICE_RANGE,'cheap'), '&lt;/less&gt;'}
;
...
;]]></Policies>
      ...
      <SendsTo messageType="com.dejima.core.messages.ActuationMessage">
        <Address Type="com.dejima.core.kernel.AgentAddress">
          <Properties Type="com.dejima.core.kernel.AgentAddress">
            <ClassName Type="java.lang.String"><![CDATA[com.dejima.core.agents.AASAPAgent]]></ClassName>
            <DomainName Type="java.lang.String"><![CDATA[x]]></DomainName>
            <Name Type="java.lang.String"><![CDATA[PRICE_RANGE]]></Name>
          </Properties>
        </Address>
      </SendsTo>
      ...
      <SendsTo messageType="com.dejima.core.messages.GetMessage">
        <Address Type="com.dejima.core.kernel.AgentAddress">
          <Properties Type="com.dejima.core.kernel.AgentAddress">
            <ClassName Type="java.lang.String"><![CDATA[com.dejima.library.constant.ConstantAgent]]></ClassName>
            <DomainName Type="java.lang.String"><![CDATA[x]]></DomainName>
            <Name Type="java.lang.String"><![CDATA[CONST_PRICE_RANGE]]></Name>
          </Properties>
        </Address>
      </SendsTo>
    ...
    <Agent>
      <Properties Type="com.dejima.library.constant.ConstantAgent">
        <Address Type="com.dejima.core.kernel.AgentAddress">
          <Properties Type="com.dejima.core.kernel.AgentAddress">
            <ClassName Type="java.lang.String"><![CDATA[com.dejima.library.constant.ConstantAgent]]></ClassName>
            <DomainName Type="java.lang.String"><![CDATA[x]]></DomainName>
        ...
        <ConfigInfo Type="com.dejima.core.agents.FileProperty">
          <Properties Type="com.dejima.core.agents.FileProperty">
            ...
            <Name Type="java.lang.String"><![CDATA[testconst.xml]]></Name>
            <Source Type="java.lang.String"><![CDATA[testconst.xml]]></Source>
          </Properties>
        </ConfigInfo>
        <ConstantName Type="java.lang.String"><![CDATA[PriceRange]]></ConstantName>
        <Description Type="com.dejima.core.kernel.AgentDescription">
          <Properties Type="com.dejima.core.kernel.AgentDescription">
            <Functionality Type="java.lang.String" />
            <Icon Type="java.lang.String"><![CDATA[/resources/agent.gif]]></Icon>
      ...
      <SendsTo messageType="com.dejima.core.messages.GetMessage">
        ...
        <Address Type="com.dejima.core.kernel.AgentAddress">
          <Properties Type="com.dejima.core.kernel.AgentAddress">
            <ClassName Type="java.lang.String"><![CDATA[com.dejima.core.agents.AASAPAgent]]></ClassName>
            <DomainName Type="java.lang.String"><![CDATA[x]]></DomainName>
            <Name Type="java.lang.String"><![CDATA[EXPENSIVE]]></Name>
          </Properties>
        </Address>
      </SendsTo>
      <SendsTo messageType="com.dejima.core.messages.SetMessage">
      ...
      <Properties Type="com.dejima.core.agents.AASAPAgent">
        <Address Type="com.dejima.core.kernel.AgentAddress">
          <Properties Type="com.dejima.core.kernel.AgentAddress">
            <ClassName Type="java.lang.String"><![CDATA[com.dejima.core.agents.AASAPAgent]]></ClassName>
            <DomainName Type="java.lang.String"><![CDATA[x]]></DomainName>
            <Name Type="java.lang.String"><![CDATA[EQUAL]]></Name>
          </Properties>
        </Address>
        <Criteria Type="com.dejima.core.nlp.text.MatchCriteria">
          <Properties Type="com.dejima.core.nlp.text.MatchCriteria">
...
;]]></Policies>
    ...
    <Agent>
      <Properties Type="com.dejima.core.agents.AASAPAgent">
        ...
        <Policies Type="java.lang.String"><![CDATA[P1:
	'expensive'
	{action: '&lt;more&gt;', get(CONST_PRICE_RANGE,'expensive'), '&lt;/more&gt;'}
;
...
;]]></Policies>
    ...
    <Agent>
      <Properties Type="com.dejima.core.agents.AASAPAgent">
        ...
        <Policies Type="java.lang.String"><![CDATA[P1:
	EXPENSIVE, CHEAP, EQUAL
	{action: '&lt;priceRange&gt;', EXPENSIVE, CHEAP, EQUAL, '&lt;/priceRange&gt;'}
;
    ...
    <Agent>
      <Properties Type="com.dejima.core.agents.AASAPAgent">
        ...
        <ExplanationFile Type="com.dejima.core.agents.FileProperty">
          <Properties Type="com.dejima.core.agents.FileProperty">
            <Directory Type="java.lang.String"><![CDATA[constant_agent]]></Directory>
            <IsLibraryCopy Type="boolean"><![CDATA[true]]></IsLibraryCopy>
            <Name Type="java.lang.String"><![CDATA[explanation.xml]]></Name>
            <Source Type="java.lang.String"><![CDATA[constant_agent\explanation.xml]]></Source>
          </Properties>
        </ExplanationFile>
        <Policies Type="java.lang.String"><![CDATA[P1:
	PRICE_RANGE+
;]]></Policies>
  ...
  <DejimaAgentNetworkLocations AgentEditorType="SWING">
    <AgentVisualization name="actuator" className="com.dejima.core.agents.ActuationAgent" domainName="x" xLocation="350" yLocation="142" expanded="true" visible="true" />
    <AgentVisualization name="CHEAP" className="com.dejima.core.agents.AASAPAgent" domainName="x" xLocation="307" yLocation="349" expanded="true" visible="true" />
    <AgentVisualization name="CONST_PRICE_RANGE" className="com.dejima.library.constant.ConstantAgent" domainName="x" xLocation="232" yLocation="459" expanded="true" visible="true" />
    <AgentVisualization name="EQUAL" className="com.dejima.core.agents.AASAPAgent" domainName="x" xLocation="405" yLocation="340" expanded="true" visible="true" />
    <AgentVisualization name="EXPENSIVE" className="com.dejima.core.agents.AASAPAgent" domainName="x" xLocation="183" yLocation="344" expanded="true" visible="true" />
    <AgentVisualization name="io" className="com.dejima.core.agents.InteractionAgent" domainName="x" xLocation="153" yLocation="129" expanded="true" visible="true" />
    <AgentVisualization name="logger" className="com.dejima.core.agents.LogAgent" domainName="x" xLocation="113" yLocation="200" expanded="true" visible="true" />
    <AgentVisualization name="PRICE_RANGE" className="com.dejima.core.agents.AASAPAgent" domainName="x" xLocation="272" yLocation="276" expanded="true" visible="true" />
    <AgentVisualization name="SYSTEM" className="com.dejima.core.agents.AASAPAgent" domainName="x" xLocation="265" yLocation="214" expanded="true" visible="true" />
